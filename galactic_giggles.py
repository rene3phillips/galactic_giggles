...
while True:
    if user_input.lower() == "roll":
        ...
        print("You rolled a " + str(dice_result) + ", propelling you into the adventure of " + stories[dice_result] + "!")
        ...
        if dice_result == 1:
            def story_1():
                ...
                print("A STELLAR DISCOVERY",
                      "During a routine scan of the cosmos,",
                      "astronomers at 'The " + adjective + " Observatory' stumbled upon an unprecedented discovery:",
                      "a planet made entirely of " + noun + ".",
                      "This planet, which they named '" + made_up + "',",
                      "orbits a(n) " + adjective2 + " star in the '" + name + " Galaxy'.",
                      "Not only is this planet unique for its composition,",
                      "but it also has rivers of liquid " + noun2 + " and clouds of " + noun3 + ",",
                      "making scientists rethink what is possible in the universe.",
                        sep="\n")
            print()
            story_1()
            print()
            ...
            def story_5():
                ...
                adjective3 = input("And again, choose another adjective: ").lower()
                print()
                print("THE INTERGALACTIC MARATHON",
            ...
            def story_6():
                ...
                verb = input("Choose a verb: ").lower()
                print()
                print("THE MYSTERY OF THE VANISHING SATELLITES",
